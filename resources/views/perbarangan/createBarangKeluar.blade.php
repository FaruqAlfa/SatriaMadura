                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('barangkeluar.store') }}" id="myForm" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="staff_id" class="formcontrol" id="staff_id" aria-describedby="staff_id">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tanggal_keluar" name="tanggal_keluar" class="formcontrol" id="tanggal_keluar"
